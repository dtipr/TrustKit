...
import logoUrl from '../../Assets/TrustKitLogo.png';

<Meta title="Getting Started/Introduction" />

<div style={{ display: 'flex', justifyContent: 'center', marginBottom: '2rem' }}>
  <img src={logoUrl} alt="TrustKit Logo" style={{ maxWidth: '280px', height: 'auto' }} />
</div>

# TrustKit

DTI's corporate React UI component library for all products.
